...
const LAYERS = [
  {
    gradient: "radial-gradient(ellipse 80% 50% at 50% 20%, rgba(var(--accent-rgb, 232,93,47),0.08) 0%, transparent 70%)",
    scrollRange: [0, 0.15],
    opacityRange: [0.8, 0],
    yRange: [0, -60],
  },
  ...
  {
    gradient: "radial-gradient(ellipse 60% 45% at 60% 50%, rgba(var(--accent-rgb, 232,93,47),0.05) 0%, transparent 65%)",
